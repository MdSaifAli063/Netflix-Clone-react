...
export default function Logo() {
  return (
    <div id="logo" className="Logo">
      {/*
        viewBox calculated from the nested transform matrix:
        matrix(2.5445375,0,0,2.5445375,1157.1714,-1457.8678)
        + translate(-384.28572,-428.81172)
        Resulting root bounding box: x=-3.1, y=0, w=298, h=79.8
      */}
      <svg
